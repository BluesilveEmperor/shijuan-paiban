---
name: "clean_exam"
description: "Cleans raw .docx exam papers, extracting text to Markdown and images. Invoke as Step1 when starting the exam formatting pipeline."
---
...
- **符号图片不硬猜**：如果 `check_pending_symbols()` 有警告，只报告不猜测内容，留待人工或 Step2 处理
