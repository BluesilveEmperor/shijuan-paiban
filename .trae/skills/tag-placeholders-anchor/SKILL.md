---
name: "tag-placeholders-anchor"
description: "用增量Edit为anchor浮动图创建占位符(v3.6)：先复制structure.json，再逐占位符Edit。作为Step3在Step2和Step4后触发。"
---

# Step3: tag-placeholders-anchor — anchor 浮动图占位（增量编辑模式）
