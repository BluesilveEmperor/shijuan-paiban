# Step 3: Tag Placeholders Anchor — anchor 浮动图占位（增量编辑模式）

> 本文档是 Geo Paper Format 流水线的 Step 3 详细规则。顶层入口见 `SKILL.md`。
> 本步骤依赖 Step2 和 Step4 均完成。当 `anchor_count == 0` 时跳过本步骤。
